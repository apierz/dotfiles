;;; nofrils-civic-theme.el --- Port of "No Frils Acme" Vim theme.
...
(let ((background "#1f1f29")
  ...
  (custom-theme-set-faces
   ...
   `(mode-line ((t :foreground ,background :background ,status)))
   `(mode-line-inactive ((t :foreground ,background :background ,fringe)))
