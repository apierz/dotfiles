...
I used to use Leuven for my color theme and Hack as my font, but I change both all the time. Transparency is commented out.
...
#+BEGIN_SRC emacs-lisp
  ...
  (defface doom-modeline-panel '((t (:inherit mode-line :foreground "#51afef" :background "#bbc2cf")))
  "Face for 'X out of Y' segments, such as `*anzu', `*evil-substitute' and
  `iedit'")

  (defface doom-modeline-info '((t (:foreground "#98be65")))
