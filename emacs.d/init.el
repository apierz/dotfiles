...
(custom-set-faces
 ...
 '(doom-modeline-info ((t (:foreground "#b8bb26"))))
 '(org-block-background ((t (:background "#272822"))))
 '(org-level-1 ((t (:foreground "#83a598" :height 1.2)))))
