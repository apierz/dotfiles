...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#20213e" :foreground "wheat3" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry "nil" :family "SF Mono"))))
 '(git-gutter:added ((t (:foreground "#67b11d"))))
 '(git-gutter:deleted ((t (:foreground "#ba2f59"))))
 '(git-gutter:modified ((t (:foreground "#8700af"))))
 '(linum-relative-current-face ((t (:inherit linum :background "#191935" :foreground "green" :weight bold)))))
