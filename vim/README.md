...
This vim configuration is taken from [Jess Fraz](https://giuthub.com/jessfraz),
with very minor tweaks. You can find her original directory [here](https://github.com/jessfraz/.vim/blob/master/vimrc).
