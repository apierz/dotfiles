...
" Baseline {{{
hi Normal		term=NONE	cterm=NONE	ctermfg=14	ctermbg=NONE	gui=NONE	guifg=#FFFFFF	guibg=#262626
" }}}

" Faded {{{
hi ColorColumn		term=NONE	cterm=NONE	ctermfg=0	ctermbg=8	gui=NONE	guifg=#000000	guibg=#585858
hi Comment		term=NONE	cterm=NONE	ctermfg=7	ctermbg=none	gui=NONE	guifg=#585858	guibg=NONE
hi FoldColumn		term=NONE	cterm=NONE	ctermfg=0	ctermbg=11	gui=NONE	guifg=#000000	guibg=#585858
hi Folded		term=NONE	cterm=NONE	ctermfg=11	ctermbg=NONE	gui=NONE	guifg=#585858	guibg=NONE
hi LineNr		term=NONE	cterm=NONE	ctermfg=7	ctermbg=15	gui=NONE	guifg=#555555	guibg=#262626
hi NonText		term=NONE	cterm=NONE	ctermfg=11	ctermbg=NONE	gui=NONE	guifg=#585858	guibg=NONE
...
hi CursorLineNr		term=NONE	cterm=NONE	ctermfg=2	ctermbg=white	gui=NONE	guifg=NONE	guibg=#000000
...
hi ErrorMsg		term=NONE	cterm=NONE	ctermfg=6	ctermbg=none	gui=NONE	guifg=NONE	guibg=#5F0000
hi Error		term=NONE	cterm=NONE	ctermfg=6	ctermbg=none	gui=NONE	guifg=NONE	guibg=#5F0000
...
" Diff {{{
hi DiffAdd		term=NONE	cterm=NONE	ctermfg=0	ctermbg=none	gui=NONE	guifg=NONE	guibg=#005F00
hi DiffChange		term=NONE	cterm=NONE	ctermfg=8	ctermbg=none	gui=NONE	guifg=NONE	guibg=#00005F
hi DiffDelete		term=NONE	cterm=NONE	ctermfg=6	ctermbg=none	gui=NONE	guifg=NONE	guibg=#5F0000
hi DiffText		term=reverse	cterm=reverse	ctermfg=NONE	ctermbg=NONE	gui=reverse	guifg=NONE	guibg=NONE
" }}}
...
hi String		term=NONE	cterm=NONE	ctermfg=14	ctermbg=NONE	gui=NONE	guifg=NONE	guibg=NONE
